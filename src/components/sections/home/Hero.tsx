  ...
  return (
    <section className="relative min-h-[600px] md:h-[500px] flex items-center overflow-hidden bg-bg-base">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 w-full">
        <div className="grid grid-cols-1 md:grid-cols-[1.2fr_1fr] items-center gap-12">
          <motion.div
          ...
          >
            ...
            <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl text-cream leading-tight mb-8">
              A Legacy of <br />
              <span className="italic text-gold">Mughlai Excellence</span>
            </h1>
